...
/// Shows a success payment overlay (not a dialog/route).
/// Uses OverlayEntry to avoid navigation stack conflicts with Get.dialog/Get.back
/// and ensure instant display regardless of other dialogs/sheets being closed.
void showSuccessfulPayment({
  ...
  // Post-frame callback ensures all previous navigation
  // (closing dialogs/sheets) has fully settled before showing overlay.
