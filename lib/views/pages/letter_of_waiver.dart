                ...
                child: Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildFormField(_phoneNumberController,
                            'المالك للخط رقم', Icons.phone_android),
                        const SizedBox(height: 20),
                        _buildFormField(_recipientNameController,
                            'تفويض للسيد/السيدة', Icons.person),
                        const SizedBox(height: 20),
                        _buildFormField(_nationalIdController, 'بطاقة رقم قومي',
                            Icons.credit_card),
                        const SizedBox(height: 20),
                        _buildFormField(_waivedPhoneController,
                            'للتنازل عن خط رقم', Icons.phone_forwarded),
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<int>(
          ...
          items: [
            DropdownMenuItem(value: 0, child: Text(_companies[0].name)),
            DropdownMenuItem(value: 1, child: Text(_companies[1].name)),
          ],
          onChanged: (value) {
  ...
  Widget _buildCompanyInfoCard() {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('اسم الشركة: ${selectedCompany.name}',
              style: const TextStyle(fontWeight: FontWeight.bold)),
          const SizedBox(height: 4),
          Text('المالك: ${selectedCompany.ownerName}'),
          const SizedBox(height: 4),
          Text(
              'رقم ضريبي: ${selectedCompany.taxNumber.split('-').reversed.join('-')}'),
        ],
      ),
    );
  }
